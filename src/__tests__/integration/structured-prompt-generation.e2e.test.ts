...
interface StructuredPromptOrchestrator {
  generateImage(input: { prompt: string; enableStructuredPrompt?: boolean }): Promise<{ success: boolean }>
}
...
describe('Structured Prompt Generation Integration Test', () => {
  ...
  describe('Prompt Optimization Feature', () => {
    ...
    // @complexity: medium
    it(
      'AC1: transforms basic prompt "create a logo" into detailed structured prompt containing purpose, design elements, and camera instructions',
      async () => {
        // Red phase: Test should fail until proper implementation
        const result = await mockGeminiTextClient.generateStructuredPrompt({ prompt: 'create a logo' })
    ...
    // @complexity: medium
    it(
      'AC2: automatically adds detailed character feature descriptions for consistency maintenance when character elements are detected in prompt',
      async () => {
        // Red phase: Test should fail until proper implementation
    ...
    // @complexity: low
    it(
      'AC3: automatically converts negative expressions like "no cars on road" to positive semantic equivalents like "quiet empty street"',
      async () => {
        // Red phase: Test should fail until proper implementation
  ...
  describe('2-Stage Orchestration Performance', () => {
    ...
    // @complexity: medium
    it(
      'AC4: completes Gemini 2.0 Flash prompt generation within 5-15 second performance target',
      async () => {
    ...
    // @complexity: high
    it(
      'AC5: successfully executes image generation using structured prompt from Gemini 2.5 Flash Image API',
      async () => {
    ...
    // @complexity: high
    it(
      'AC6: maintains total processing time within +20 second limit compared to traditional direct generation workflow',
      async () => {
  ...
  describe('Fallback Mechanism', () => {
    ...
    // @complexity: high
    it(
      'AC7: automatically continues with original prompt for image generation when prompt generation API encounters error',
      async () => {
    ...
    // @complexity: medium
    it(
      'AC8: activates fallback processing when prompt generation exceeds 15 second timeout threshold',
      async () => {
    ...
    // @complexity: low
    it(
      'AC9: explicitly notifies LLM/users through StructuredContent when fallback generates image with unstructured prompt',
      async () => {
  ...
  describe('Best Practice #1: Be Hyper-Specific', () => {
    ...
    // @complexity: medium
    it(
      'BP1: transforms vague descriptions like "fantasy armor" into detailed specifications like "ornate elven plate armor, etched with silver leaf patterns, high collar and pauldrons shaped like falcon wings"',
      async () => {
  ...
  describe('Best Practice #2: Fix Character Consistency', () => {
    ...
    // @complexity: medium
    it(
      'BP2: automatically adds detailed character feature descriptions to maintain consistency across multiple image generations',
      async () => {
    ...
    // @complexity: high
    it(
      'BP2-advanced: detects character feature drift after iterative edits and suggests restarting conversation with detailed description',
      async () => {
  ...
  describe('Best Practice #3: Provide Context and Intent', () => {
    ...
    // @complexity: medium
    it(
      'BP3: automatically analyzes image purpose and adds appropriate context like "Create a logo for a high-end, minimalist skincare brand" vs generic "Create a logo"',
      async () => {
  ...
  describe('Best Practice #4: Iterate and Refine', () => {
    ...
    // @complexity: low
    it(
      'BP4: provides improvement guidance for iterative refinement with suggestions like "make the lighting warmer" or "change character expression to more serious"',
      async () => {
  ...
  describe('Best Practice #5: Use Semantic Negative Prompts', () => {
    ...
    // @complexity: medium
    it(
      'BP5: converts negative instructions like "no cars" into positive scene descriptions like "an empty, deserted street with no signs of traffic"',
      async () => {
  ...
  describe('Best Practice #6: Aspect Ratios', () => {
    ...
    // @complexity: low
    it(
      'BP6: confirms that Gemini 2.5 Flash Image preserves input image aspect ratios during editing operations',
      async () => {
    ...
    // @complexity: medium
    it(
      'BP6-multiple: adopts aspect ratio from the last uploaded image when multiple images with different ratios are provided',
      async () => {
  ...
  describe('Best Practice #7: Control the Camera', () => {
    ...
    // @complexity: low
    it(
      'BP7: automatically adds photographic and cinematic terminology like "wide-angle shot", "macro shot", "low-angle perspective", "85mm portrait lens", "Dutch angle" for precise composition control',
      async () => {
        ...
        // This will fail because mock returns empty string
        expect(result).toMatch(/wide-angle shot|macro shot|low-angle perspective|85mm portrait lens|Dutch angle/)
      }
    )
  })
  ...
  describe('Existing System Compatibility', () => {
    ...
    // @complexity: high
    it(
      'AC10: maintains 100% existing functionality and behavior when structured prompt feature is disabled',
      async () => {
    ...
    // @complexity: high
    it(
      'AC11: properly integrates all existing generate_image tool parameters into structured prompt optimization process rather than simple concatenation',
      async () => {
    ...
    // @complexity: medium
    it(
      'AC12: enables new functionality without requiring any changes to existing configuration files',
      async () => {
  ...
  describe('Performance Metrics', () => {
    ...
    // @complexity: medium
    it(
      'PERF1: measures and validates total processing time remains within +20 second tolerance compared to direct generation',
      async () => {
        // Red phase: Test should fail until proper performance measurement
    ...
    // @complexity: low
    it(
      'PERF2: tracks dual API call efficiency and cost implications of 2-stage orchestration approach',
      async () => {
    ...
    // @complexity: medium
    it(
      'PERF3: validates memory usage remains optimal during structured prompt data processing and temporary storage',
      async () => {
  ...
  describe('Quality Assurance Metrics', () => {
    ...
    // @complexity: high
    it(
      'QUALITY1: measures prompt optimization effectiveness through before/after comparison of generated image quality',
      async () => {
    ...
    // @complexity: medium
    it(
      'QUALITY2: validates comprehensive application of all 7 best practices across different prompt types and scenarios',
      async () => {
    ...
    // @complexity: medium
    it(
      'QUALITY3: measures and validates >98% success rate for prompt generation across various prompt categories and complexity levels',
      async () => {
  ...
  describe('Error Handling', () => {
    ...
    // @complexity: medium
    it(
      'ERROR1: handles network connectivity issues during prompt generation with appropriate fallback to original prompt',
      async () => {
    ...
    // @complexity: medium
    it(
      'ERROR2: manages API rate limiting scenarios with intelligent retry and fallback mechanisms',
      async () => {
    ...
    // @complexity: high
    it(
      'ERROR3: handles invalid or malformed API responses from prompt generation service with graceful degradation',
      async () => {
    ...
    // @complexity: high
    it(
      'ERROR4: manages concurrent prompt generation requests without resource conflicts or data corruption',
      async () => {
  ...
  describe('Input Validation Edge Cases', () => {
    ...
    // @complexity: low
    it(
      'EDGE1: handles empty or whitespace-only prompts with appropriate error messages and fallback behavior',
      async () => {
    ...
    // @complexity: medium
    it(
      'EDGE2: processes extremely long prompts (near API token limits) with appropriate truncation or chunking strategies',
      async () => {
    ...
    // @complexity: low
    it(
      'EDGE3: correctly handles special characters, emojis, and non-ASCII text in prompt optimization process',
      async () => {
    ...
    // @complexity: medium
    it(
      'EDGE4: maintains optimization effectiveness across different languages while preserving original language in output',
      async () => {
  ...
  describe('Configuration Management', () => {
    ...
    // @complexity: medium
    it(
      'CONFIG1: supports dynamic switching between structured and traditional prompt processing without server restart',
      async () => {
    ...
    // @complexity: medium
    it(
      'CONFIG2: properly manages dual API client configuration for Gemini 2.0 Flash and 2.5 Flash Image models',
      async () => {
    ...
    // @complexity: low
    it(
      'CONFIG3: provides granular feature flag control for individual best practices and orchestration components',
      async () => {
  ...
  describe('Backward Compatibility', () => {
    ...
    // @complexity: high
    it(
      'COMPAT1: maintains full compatibility with existing MCP clients without requiring client-side updates',
      async () => {
    ...
    // @complexity: medium
    it(
      'COMPAT2: preserves existing API contracts and response formats while extending functionality',
      async () => {
    ...
    // @complexity: high
    it(
      'COMPAT3: validates seamless migration path from existing implementation to structured prompt generation',
      async () => {
  ...
  describe('Security Considerations', () => {
    ...
    // @complexity: medium
    it(
      'SECURITY1: ensures proper isolation and protection of API keys for both text and image generation services',
      async () => {
    ...
    // @complexity: medium
    it(
      'SECURITY2: implements appropriate sanitization for user prompts to prevent injection attacks or inappropriate content',
      async () => {
    ...
    // @complexity: low
    it(
      'SECURITY3: ensures complete cleanup of temporary structured prompt data after processing completion',
      async () => {
  ...
  describe('Monitoring and Metrics', () => {
    ...
    // @complexity: medium
    it(
      'MONITOR1: collects comprehensive performance metrics for prompt generation, image generation, and total processing times',
      async () => {
    ...
    // @complexity: low
    it(
      'MONITOR2: tracks success and failure rates for both prompt generation and fallback scenarios',
      async () => {
    ...
    // @complexity: medium
    it(
      'MONITOR3: tracks API usage costs and provides insights for cost optimization across dual-client architecture',
      async () => {
    ...
    // @complexity: low
    it(
      'MONITOR4: implements configurable alert thresholds for processing time, error rates, and cost metrics',
      async () => {
